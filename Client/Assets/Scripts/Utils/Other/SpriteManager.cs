...
public class SpriteManager : MonoBehaviour 
{
    ...
    protected LSprite[] sprites;             // Array of all sprites (the offset of the vertices corresponding to each sprite should be found simply by taking the sprite's index * 4 (4 verts per sprite).
    ...
    // Working vars:
    protected int i;
    protected LSprite tempSprite = null;
    ...
    {
        sprites = new LSprite[1];
        sprites[0] = new LSprite();
    ...
    protected int EnlargeArrays(int count)
    {
        ...
        // Resize sprite array:
        LSprite[] tempSprites = sprites;
        sprites = new LSprite[sprites.Length + count];
    ...
    public LSprite AddSprite(GameObject client, float width, float height, int leftPixelX, int bottomPixelY, int pixelWidth, int pixelHeight, bool billboarded)
    {
    ...
    public LSprite AddSprite(GameObject client, float width, float height, int leftPixelX, int bottomPixelY, int pixelWidth, int pixelHeight, Vector3 offset, bool billboarded)
    {
    ...
    // offset - the sprite will be offseted by the specified Vector3 relative to the client transform
    public LSprite AddSprite(GameObject client, float width, float height, Vector2 lowerLeftUV, Vector2 UVDimensions, Vector3 offset, bool billboarded)
    {
        int spriteIndex;
    ...
    Vector3 CalculateNormal( LSprite sprite )
    {
    ...
    public void SetBillboarded(LSprite sprite)
    {
    ...
    public void RemoveSprite(LSprite sprite)
    {
    ...
    public void HideSprite(LSprite sprite)
    {
        // Remove the sprite from the billboarded list
    ...
    public void ShowSprite(LSprite sprite)
    {
    ...
    public void MoveToFront(LSprite s)
    {
    ...
    public void MoveToBack(LSprite s)
    {
        int[] indices = new int[6];
        int offset = spriteDrawOrder.IndexOf(s) * 6;
    ...
    public void MoveInfrontOf(LSprite toMove, LSprite reference)
    {
        int[] indices = new int[6];
    ...
    public void MoveBehind(LSprite toMove, LSprite reference)
    {
        int[] indices = new int[6];
        int offset = spriteDrawOrder.IndexOf(toMove) * 6;
        int refOffset = spriteDrawOrder.IndexOf(reference) * 6;
    ...
    public void AnimateSprite(LSprite s)
    {
        // Add this sprite to our playingAnimation list:
        playingAnimations.Add(s);
    }
    
    public void StopAnimation(LSprite s)
    {
        playingAnimations.Remove(s);
    }
    
    public LSprite GetSprite(int i)
    {
        if (i < sprites.Length)
            return sprites[i];
        else
    ...
    public void Transform(LSprite sprite)
    {
        sprite.Transform();
    ...
    public void TransformBillboarded(LSprite sprite)
    {
    ...
    public void UpdateUV(LSprite sprite)
    {
    ...
    public void UpdateColors(LSprite sprite)
    {
    ...
    virtual public void LateUpdate () 
    {
        ...
        if(playingAnimations.Count > 0)
        {
            ...
            {
                tempSprite = (LSprite)playingAnimations[i];
